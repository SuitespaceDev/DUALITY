...
{
	struct HV4DSUBJECT : HV4DSUBJECTT<HV4DSUBJECT>
	{
	public:
		HV4DSUBJECT();

		HV4DSUBJECT(HV4D::IHV4DCOBJECT const&);

		HV4DSUBJECT(HV4D::IHV4DCOBJECT const&, winrt::guid const&, WF::IInspectable const&);
...
{
	struct HV4DSUBJECT : HV4DSUBJECTT<HV4DSUBJECT, implementation::HV4DSUBJECT>
	{
