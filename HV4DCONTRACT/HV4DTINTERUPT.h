...
#include "HV4DTINTERUPT.g.h"

namespace winrt::HV4DABI::implementation
{
	struct HV4DTINTERUPT : HV4DTINTERUPTT<HV4DTINTERUPT>
	{
	public:
		HV4DTINTERUPT();
...
{
	struct HV4DTINTERUPT : HV4DTINTERUPTT<HV4DTINTERUPT, implementation::HV4DTINTERUPT>
	{
