...
{
	struct HV4DMESH : HV4DMESHT<HV4DMESH>
	{
	public:
		HV4DMESH();

		HV4DMESH(HV4D::IHV4DCOBJECT const&);

		HV4DMESH(HV4D::IHV4DCOBJECT const&, winrt::guid const&, WF::IInspectable const&);
...
{
	struct HV4DMESH : HV4DMESHT<HV4DMESH, implementation::HV4DMESH>
	{
