...
namespace winrt::HV4DABI
{
	...
	void CHV4DMMDDYYYY::HV4DIsValidMMDDYYYY()
	{
		if (tagMMDDYYYY[0] == '\0')
		{
			memset(tagMMDDYYYY, '\0', sizeof(tagMMDDYYYY));
		...
		hstring mm{ L"" + tagMMDDYYYY[0] + tagMMDDYYYY[1] };
		hstring dd{ L"" + tagMMDDYYYY[2] + tagMMDDYYYY[3] };
		hstring yyyy{ L"" + tagMMDDYYYY[4] + tagMMDDYYYY[5] + tagMMDDYYYY[6] + tagMMDDYYYY[7] };
	...
	bool CHV4DMMDDYYYY::operator == (hstring const& s)
	{
		try
		{
			HV4DIsValidMMDDYYYY();
	...
	bool CHV4DMMDDYYYY::operator == (MMDDYYYY const& e)
	{
		try
		{
			HV4DIsValidMMDDYYYY();
	...
	bool CHV4DMMDDYYYY::operator == (CHV4DMMDDYYYY const& e)
	{
		try
		{
			HV4DIsValidMMDDYYYY();
		...
		{
			if (tagMMDDYYYY[i] != mmddyyyy.tagMMDDYYYY[i])
			{
				return false;
	...
	bool CHV4DMMDDYYYY::operator > (CHV4DMMDDYYYY const& e)
	{
		...
		int a_mm = std::stoi(std::wstring{ L"" + tagMMDDYYYY[0] + tagMMDDYYYY[1] });
		int b_mm = std::stoi(std::wstring{ L"" + mmddyyyy.tagMMDDYYYY[0] + mmddyyyy.tagMMDDYYYY[1] });

		int a_dd = std::stoi(std::wstring{ L"" + tagMMDDYYYY[2] + tagMMDDYYYY[3] });
		int b_dd = std::stoi(std::wstring{ L"" + mmddyyyy.tagMMDDYYYY[2] + mmddyyyy.tagMMDDYYYY[3] });

		int a_yyyy = std::stoi(std::wstring{ L"" + tagMMDDYYYY[4] + tagMMDDYYYY[5] + tagMMDDYYYY[6] + tagMMDDYYYY[7] });
		int b_yyyy = std::stoi(std::wstring{ L"" + mmddyyyy.tagMMDDYYYY[4] + mmddyyyy.tagMMDDYYYY[5] + mmddyyyy.tagMMDDYYYY[6] + mmddyyyy.tagMMDDYYYY[7] });
	...
	HV4DRETURN CHV4DMMDDYYYY::HV4DGetHstringMMDDYYYY(hstring& o)
	{
		try
		{
			HV4DIsValidMMDDYYYY();
	...
	HV4DRETURN CHV4DMMDDYYYY::HV4DGetNumericMMDDYYYY(uint32_t& mm, uint32_t& dd, uint32_t& yyyy)
	{
		try
		{
			HV4DIsValidMMDDYYYY();
		...
		hstring str_mm = L"" + tagMMDDYYYY[0] + tagMMDDYYYY[1];

		hstring str_dd = L"" + tagMMDDYYYY[2] + tagMMDDYYYY[3];

		hstring str_yyyy = L"" + tagMMDDYYYY[4] + tagMMDDYYYY[5] + tagMMDDYYYY[6] + tagMMDDYYYY[7];
	...
	HV4DRETURN CHV4DMMDDYYYY::HV4DGetArrayMMDDYYYY(wchar_t a[8])
	{
		try
		{
			HV4DIsValidMMDDYYYY();
	...
	HV4DRETURN CHV4DMMDDYYYY::HV4DGetWinrtMMDDYYYY(MMDDYYYY& o)
	{
		try
		{
			HV4DIsValidMMDDYYYY();
		...
		o.mm = L"" + tagMMDDYYYY[0] + tagMMDDYYYY[1];

		o.dd = L"" + tagMMDDYYYY[2] + tagMMDDYYYY[3];

		o.yyyy = L"" + tagMMDDYYYY[4] + tagMMDDYYYY[5] + tagMMDDYYYY[6] + tagMMDDYYYY[7];
