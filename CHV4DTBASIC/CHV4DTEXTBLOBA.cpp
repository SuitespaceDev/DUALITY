...
namespace CHV4D::CHV4DTBASIC
{
	...
	void CHV4DTEXTBLOBA::HV4DGetStringTEXTBLOBA(std::wstring& o) const
	{
		o = tagTEXTBLOBA;
	...
	void CHV4DTEXTBLOBA::HV4DSubStr(uint64_t const& i, uint64_t const& l, CHV4DTEXTBLOBA& o)
	{
		o = tagTEXTBLOBA.substr(i, l);
