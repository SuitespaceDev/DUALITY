...
{
    struct UserIterableList : UserIterableListT<UserIterableList>
    {
    public:
        UserIterableList();
...
{
    struct UserIterableList : UserIterableListT<UserIterableList, implementation::UserIterableList>
    {
    };
}
