...
namespace winrt::HV4DUX::implementation
{
	...
	{
		if (HV4DUX::UserIPv6 Control{ obj.try_as<HV4DUX::UserIPv6>() })
		{
			//HV4DUX::implementation::UserIPv6* ptr{ winrt::get_self<HV4DUX::implementation::UserIPv6>(Control) };
	...
	MUX::DependencyProperty UserIPv6::value_property =
		MUX::DependencyProperty::Register(
			...
			winrt::xaml_typename<winrt::HV4DUX::UserIPv6>(),
