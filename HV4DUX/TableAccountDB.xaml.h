...
#include "TableAccountDB.g.h"

namespace winrt::HV4DUX::implementation
{
    struct TableAccountDB : TableAccountDBT<TableAccountDB>
    {
    public:
        TableAccountDB();
...
{
    struct TableAccountDB : TableAccountDBT<TableAccountDB, implementation::TableAccountDB>
    {
    };
}
