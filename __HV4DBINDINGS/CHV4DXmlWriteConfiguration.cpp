...
{
	CHV4DXmlWriteConfiguration::CHV4DXmlWriteConfiguration()
	{
		$HV4D = CHV4DSYSFILE{};
	...
	HV4DRETURN CHV4DXmlWriteConfiguration::HV4DExecuteWriteDocumentToXml(CHV4DSYSFILE const& e)
	{
		try
		{
			$HV4D = e;
		...
		hstring path = hstring{ WinrtSystemFile.file.p } + WinrtSystemFile.file.f;
	...
	HV4DRETURN CHV4DXmlWriteConfiguration::HV4DWriteToDocumentStream(std::unordered_map<HV4D_DUALITY_FIELD_ID, hstring> const& e)
	{
	...
	HV4DRETURN CHV4DXmlWriteConfiguration::HV4DWriteToModuleStream(std::unordered_map<HV4D::HV4DENUM::HV4D_FILE_SYSTEM_MODULE_ID, HV4D::HV4DDUALITY::CHV4DRTCLASS> const& e)
	{
	...
	HV4DRETURN CHV4DXmlWriteConfiguration::HV4DClearDocumentStream()
	{
		$HV4D = CHV4DSYSFILE{};
	...
	HV4DRETURN CHV4DXmlWriteConfiguration::HV4DWriteDocumentToXml(pugi::xml_node const& e)
	{
	...
	HV4DRETURN CHV4DXmlWriteConfiguration::HV4DWriteModulesToXml(pugi::xml_node const& e)
	{
