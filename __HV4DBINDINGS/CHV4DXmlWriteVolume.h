...
namespace winrt::HV4D::HV4DDUALITY
{
	...
	public:
		...
		HV4D::HV4DRETURN HV4DWriteToDocumentStream(std::unordered_map<HV4D::HV4DFIELD::HV4D_DUALITY_FIELD_ID, hstring> const&);
	...
	private:
		...
		std::unordered_map<HV4D::HV4DFIELD::HV4D_DUALITY_FIELD_ID, hstring> DocumentStream{};
