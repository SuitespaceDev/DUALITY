...
namespace winrt::Duality137::implementation
{
	...
	void Machine::InitializeIndex()
	{
		Pages = new std::unordered_map<CTBASIC::CHV4DKEY, std::function<bool()>, CTBASIC::CHV4DKEYFN>{
			...
			{ {winrt::guid{0xEDC1BCCE, 0xD74E, 0x4C1C, {0x9D, 0xD7, 0x7C, 0x5E, 0xBD, 0xAF, 0x31, 0xB0}}   ,L"BindPostgresPage"         }, std::function<bool()>{ [this]() { return MachineFrame().Navigate(winrt::xaml_typename<Duality137::BindPostgresPage>()); } } },
