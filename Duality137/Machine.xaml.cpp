...
namespace winrt::Duality137::implementation
{
	...
	void Machine::InitializeIndex()
	{
		Pages = new std::unordered_map<CTBASIC::CHV4DKEY, std::function<bool()>, CTBASIC::CHV4DKEYFN>{
			...
			{ {winrt::guid{0x176C375B, 0xB220, 0x4A32, {0xB9, 0x65, 0x18, 0xF2, 0x29, 0xC8, 0x19, 0xA5}}   ,L"InterfacePortPage"        }, std::function<bool()>{ [this]() { return PropertyPane().Navigate(winrt::xaml_typename<Duality137::InterfacePortPage>()); } } },
			...
			{ {winrt::guid{0x1FB6C794, 0xC781, 0x436A, {0x8B, 0xD6, 0xC7, 0xE3, 0x04, 0x9C, 0x44, 0x91}}   ,L"PeripheralDevicePage"		}, std::function<bool()>{ [this]() { return PropertyPane().Navigate(winrt::xaml_typename<Duality137::PeripheralDevicePage>()); } } },
