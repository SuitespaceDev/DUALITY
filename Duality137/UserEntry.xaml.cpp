...
namespace winrt::Duality137::implementation
{
	...
	{
		if (Duality137::UserEntry Control{ obj.try_as<Duality137::UserEntry>() })
		{
			//Duality137::implementation::UserEntry* ptr{ winrt::get_self<Duality137::implementation::UserEntry>(Control) };
	...
	MUX::DependencyProperty UserEntry::value_property =
		MUX::DependencyProperty::Register(
			...
			winrt::xaml_typename<winrt::Duality137::UserEntry>(),
