...
{
    struct UserFilterNewItem : UserFilterNewItemT<UserFilterNewItem>
    {
	public:
        UserFilterNewItem();
...
{
    struct UserFilterNewItem : UserFilterNewItemT<UserFilterNewItem, implementation::UserFilterNewItem>
    {
    };
}
