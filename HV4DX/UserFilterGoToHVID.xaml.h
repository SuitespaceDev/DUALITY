...
#include "UserFilterGoToHVID.g.h"
...
{
    struct UserFilterGoToHVID : UserFilterGoToHVIDT<UserFilterGoToHVID>
    {
    public:
        UserFilterGoToHVID();
...
{
    struct UserFilterGoToHVID : UserFilterGoToHVIDT<UserFilterGoToHVID, implementation::UserFilterGoToHVID>
    {
    };
}
