...
#include "HV4DT_TYPE_RTCLASS.g.h"
...
{
	struct HV4DT_TYPE_RTCLASS : HV4DT_TYPE_RTCLASST<HV4DT_TYPE_RTCLASS>
	{
	public:
		HV4DT_TYPE_RTCLASS();

		HV4DT_TYPE_RTCLASS(HV4D::IHV4DOBJECT const&);

		HV4DT_TYPE_RTCLASS(HV4D::IHV4DOBJECT const&, winrt::guid const&, WF::IInspectable const&);
...
{
	struct HV4DT_TYPE_RTCLASS : HV4DT_TYPE_RTCLASST<HV4DT_TYPE_RTCLASS, implementation::HV4DT_TYPE_RTCLASS>
	{
