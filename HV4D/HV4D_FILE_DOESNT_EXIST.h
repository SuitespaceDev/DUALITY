...
#include "HV4D_FILE_DOESNT_EXIST.g.h"

namespace WF = winrt::Windows::Foundation;

namespace winrt::HV4D::implementation
{
	struct HV4D_FILE_DOESNT_EXIST : HV4D_FILE_DOESNT_EXISTT<HV4D_FILE_DOESNT_EXIST>
	{
	public:
		HV4D_FILE_DOESNT_EXIST();

	public:
		winrt::guid ReturnType() { return winrt::guid{ L"{82DE6502-2DF2-4CDC-B14F-5E5CEDBCB425}" }; }

	public:
		uint64_t ID() { return 0x82DE65022DF24CDC; };

	public:
		winrt::hstring Name() { return L"HV4D_FILE_DOESNT_EXIST"; }
...
{
	struct HV4D_FILE_DOESNT_EXIST : HV4D_FILE_DOESNT_EXISTT<HV4D_FILE_DOESNT_EXIST, implementation::HV4D_FILE_DOESNT_EXIST>
	{
