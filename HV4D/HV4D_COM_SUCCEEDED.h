...
#include "HV4D_COM_SUCCEEDED.g.h"
...
{
	struct HV4D_COM_SUCCEEDED : HV4D_COM_SUCCEEDEDT<HV4D_COM_SUCCEEDED>
	{
	public:
		HV4D_COM_SUCCEEDED();

		HV4D_COM_SUCCEEDED(HV4D::IHV4DCOBJECT const&);

		HV4D_COM_SUCCEEDED(HV4D::IHV4DCOBJECT const&, winrt::guid const&, WF::IInspectable const&);
...
{
	struct HV4D_COM_SUCCEEDED : HV4D_COM_SUCCEEDEDT<HV4D_COM_SUCCEEDED, implementation::HV4D_COM_SUCCEEDED>
	{
