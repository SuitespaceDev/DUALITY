...
#include "HV4D_PROCESS_NOT_FOUND.g.h"

namespace WF = winrt::Windows::Foundation;

namespace winrt::HV4D::implementation
{
	struct HV4D_PROCESS_NOT_FOUND : HV4D_PROCESS_NOT_FOUNDT<HV4D_PROCESS_NOT_FOUND>
	{
	public:
		HV4D_PROCESS_NOT_FOUND();

	public:
		winrt::guid ReturnType() { return winrt::guid{ L"{F553E3E0-D4D1-4250-AAF2-92A6216F2394}" }; }

	public:
		uint64_t ID() { return 0xF553E3E0D4D14250; };

	public:
		winrt::hstring Name() { return L"HV4D_PROCESS_NOT_FOUND"; }
...
{
	struct HV4D_PROCESS_NOT_FOUND : HV4D_PROCESS_NOT_FOUNDT<HV4D_PROCESS_NOT_FOUND, implementation::HV4D_PROCESS_NOT_FOUND>
	{
