...
#include "HV4D_FALSE.g.h"

namespace WF = winrt::Windows::Foundation;

namespace winrt::HV4D::implementation
{
	struct HV4D_FALSE : HV4D_FALSET<HV4D_FALSE>
	{
	public:
		HV4D_FALSE();

	public:
		winrt::guid ReturnType() { return winrt::guid{ L"{FD777A9F-30F0-46FA-A264-8AA858BB5DFE}" }; }

	public:
		uint64_t ID() { return 0x0000000000000000; };

	public:
		winrt::hstring Name() { return L"HV4D_FALSE"; }
...
{
	struct HV4D_FALSE : HV4D_FALSET<HV4D_FALSE, implementation::HV4D_FALSE>
	{
