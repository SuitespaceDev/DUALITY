...
namespace winrt::HV4D::implementation
{
	...
	HV4D_FALSE::HV4D_FALSE(HV4D::IHV4DOBJECT const& sender)
	{
		HV4DListSupportedInterfaces();
	...
	HV4D_FALSE::HV4D_FALSE(HV4D::IHV4DOBJECT const& sender, winrt::guid const& boxed, WF::IInspectable const& args)
	{
		HV4DListSupportedInterfaces();
	...
	HV4D::IHV4DOBJECT HV4D_FALSE::HV4DSender()
	{
		HV4DSetUpdatedDateTime();
	...
	void HV4D_FALSE::HV4DSender(HV4D::IHV4DOBJECT const& e)
	{
		HV4DSetUpdatedDateTime();
	...
	winrt::guid HV4D_FALSE::HV4DReturnType()
	{
		HV4DSetUpdatedDateTime();
