...
#include "HV4DT_TYPE_LIBRARY.g.h"

namespace WF = winrt::Windows::Foundation;

namespace winrt::HV4D::implementation
{
	struct HV4DT_TYPE_LIBRARY : HV4DT_TYPE_LIBRARYT<HV4DT_TYPE_LIBRARY>
	{
	public:
		HV4DT_TYPE_LIBRARY();

	public:
		winrt::guid HV4DTType() { return winrt::guid{ L"{9F5BDC60-84C7-4A81-9D29-84C97AC670B9}" }; }

	public:
		uint64_t HV4DTTypeID() { return 0x9F5BDC6084C74A81; };

	public:
		winrt::hstring HV4DTTypeName() { return L"HV4DT_TYPE_LIBRARY"; }
...
{
	struct HV4DT_TYPE_LIBRARY : HV4DT_TYPE_LIBRARYT<HV4DT_TYPE_LIBRARY, implementation::HV4DT_TYPE_LIBRARY>
	{
