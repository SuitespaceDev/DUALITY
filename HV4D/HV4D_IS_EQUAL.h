...
{
	struct HV4D_IS_EQUAL : HV4D_IS_EQUALT<HV4D_IS_EQUAL>
	{
	public:
		HV4D_IS_EQUAL();

		HV4D_IS_EQUAL(HV4D::IHV4DCOBJECT const&);

		HV4D_IS_EQUAL(HV4D::IHV4DCOBJECT const&, winrt::guid const&, WF::IInspectable const&);
...
{
	struct HV4D_IS_EQUAL : HV4D_IS_EQUALT<HV4D_IS_EQUAL, implementation::HV4D_IS_EQUAL>
	{
