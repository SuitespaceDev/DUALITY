...
namespace winrt::HV4D::implementation
{
	...
	HV4DT_TYPE_EVENT::HV4DT_TYPE_EVENT(HV4D::IHV4DCOBJECT const& sender)
	{
		HV4DListSupportedInterfaces();
	...
	HV4DT_TYPE_EVENT::HV4DT_TYPE_EVENT(HV4D::IHV4DCOBJECT const& sender, winrt::guid const& boxed, WF::IInspectable const& args)
	{
		HV4DListSupportedInterfaces();
	...
	HV4D::IHV4DCOBJECT HV4DT_TYPE_EVENT::HV4DSender()
	{
		HV4DSetUpdatedDateTime();
	...
	void HV4DT_TYPE_EVENT::HV4DSender(HV4D::IHV4DCOBJECT const& e)
	{
		HV4DSetUpdatedDateTime();
	...
	winrt::guid HV4DT_TYPE_EVENT::HV4DTTypeUid()
	{
		HV4DSetUpdatedDateTime();
