...
namespace winrt::HV4D::implementation
{
	...
	public:
		winrt::guid ReturnType() { return winrt::guid{ L"{75E5CEDC-ACA7-4399-B093-C54799EBFEA8}" }; }

	public:
		uint64_t ID() { return 0x0000000000000001; };

	public:
		winrt::hstring Name() { return L"HV4D_TRUE"; }
