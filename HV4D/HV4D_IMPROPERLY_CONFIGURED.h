...
#include "HV4D_IMPROPERLY_CONFIGURED.g.h"

namespace WF = winrt::Windows::Foundation;

namespace winrt::HV4D::implementation
{
	struct HV4D_IMPROPERLY_CONFIGURED : HV4D_IMPROPERLY_CONFIGUREDT<HV4D_IMPROPERLY_CONFIGURED>
	{
	public:
		HV4D_IMPROPERLY_CONFIGURED();

	public:
		winrt::guid ReturnType() { return winrt::guid{ L"{12C23EAC-2FED-40BC-A36D-CFDDFF06546A}" }; }

	public:
		uint64_t ID() { return 0x12C23EAC2FED40BC; };

	public:
		winrt::hstring Name() { return L"HV4D_IMPROPERLY_CONFIGURED"; }
...
{
	struct HV4D_IMPROPERLY_CONFIGURED : HV4D_IMPROPERLY_CONFIGUREDT<HV4D_IMPROPERLY_CONFIGURED, implementation::HV4D_IMPROPERLY_CONFIGURED>
	{
