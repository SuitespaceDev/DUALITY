...
#include "HV4DT_TYPE_ITERATOR.g.h"
...
{
	struct HV4DT_TYPE_ITERATOR : HV4DT_TYPE_ITERATORT<HV4DT_TYPE_ITERATOR>
	{
	public:
		HV4DT_TYPE_ITERATOR();

		HV4DT_TYPE_ITERATOR(HV4D::IHV4DCOBJECT const&);

		HV4DT_TYPE_ITERATOR(HV4D::IHV4DCOBJECT const&, winrt::guid const&, WF::IInspectable const&);
...
{
	struct HV4DT_TYPE_ITERATOR : HV4DT_TYPE_ITERATORT<HV4DT_TYPE_ITERATOR, implementation::HV4DT_TYPE_ITERATOR>
	{
