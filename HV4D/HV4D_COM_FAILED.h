...
{
	struct HV4D_COM_FAILED : HV4D_COM_FAILEDT<HV4D_COM_FAILED>
	{
	public:
		HV4D_COM_FAILED();

		HV4D_COM_FAILED(HV4D::IHV4DCOBJECT const&);

		HV4D_COM_FAILED(HV4D::IHV4DCOBJECT const&, winrt::guid const&, WF::IInspectable const&);
...
{
	struct HV4D_COM_FAILED : HV4D_COM_FAILEDT<HV4D_COM_FAILED, implementation::HV4D_COM_FAILED>
	{
