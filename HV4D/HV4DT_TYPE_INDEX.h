...
namespace winrt::HV4D::implementation
{
	...
	public:
		winrt::guid HV4DTType() { return winrt::guid{ L"{782FCF8D-A009-4813-BD01-5B0F300A3BA3}" }; }

	public:
		uint64_t HV4DTTypeID() { return 0x782FCF8DA0094813; };

	public:
		winrt::hstring HV4DTTypeName() { return L"HV4DT_TYPE_INDEX"; }
