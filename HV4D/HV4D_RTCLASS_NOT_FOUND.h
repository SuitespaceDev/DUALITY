...
#include "HV4D_RTCLASS_NOT_FOUND.g.h"

namespace WF = winrt::Windows::Foundation;

namespace winrt::HV4D::implementation
{
	struct HV4D_RTCLASS_NOT_FOUND : HV4D_RTCLASS_NOT_FOUNDT<HV4D_RTCLASS_NOT_FOUND>
	{
	public:
		HV4D_RTCLASS_NOT_FOUND();

	public:
		winrt::guid ReturnType() { return winrt::guid{ L"{29099B5A-C683-407A-A9D8-A537CCF39E5C}" }; }

	public:
		uint64_t ID() { return 0x29099B5AC683407A; };

	public:
		winrt::hstring Name() { return L"HV4D_RTCLASS_NOT_FOUND"; }
...
{
	struct HV4D_RTCLASS_NOT_FOUND : HV4D_RTCLASS_NOT_FOUNDT<HV4D_RTCLASS_NOT_FOUND, implementation::HV4D_RTCLASS_NOT_FOUND>
	{
