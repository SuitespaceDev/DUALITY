...
#include "HV4DT_TYPE_PROVIDER.g.h"

namespace WF = winrt::Windows::Foundation;

namespace winrt::HV4D::implementation
{
	struct HV4DT_TYPE_PROVIDER : HV4DT_TYPE_PROVIDERT<HV4DT_TYPE_PROVIDER>
	{
	public:
		HV4DT_TYPE_PROVIDER();

	public:
		winrt::guid HV4DTType() { return winrt::guid{ L"{ADA16B2B-ABC7-4806-BACC-17BB9CAB65C0}" }; }

	public:
		uint64_t HV4DTTypeID() { return 0xADA16B2BABC74806; };

	public:
		winrt::hstring HV4DTTypeName() { return L"HV4DT_TYPE_PROVIDER"; }
...
{
	struct HV4DT_TYPE_PROVIDER : HV4DT_TYPE_PROVIDERT<HV4DT_TYPE_PROVIDER, implementation::HV4DT_TYPE_PROVIDER>
	{
