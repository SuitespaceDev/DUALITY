...
{
	struct HV4D_IS_LESSER : HV4D_IS_LESSERT<HV4D_IS_LESSER>
	{
	public:
		HV4D_IS_LESSER();

		HV4D_IS_LESSER(HV4D::IHV4DCOBJECT const&);

		HV4D_IS_LESSER(HV4D::IHV4DCOBJECT const&, winrt::guid const&, WF::IInspectable const&);
...
{
	struct HV4D_IS_LESSER : HV4D_IS_LESSERT<HV4D_IS_LESSER, implementation::HV4D_IS_LESSER>
	{
