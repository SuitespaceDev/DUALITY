...
namespace winrt::HV4D::implementation
{
	...
	HV4DT_TYPE_ITERATOR::HV4DT_TYPE_ITERATOR(HV4D::IHV4DOBJECT const& sender)
	{
		HV4DListSupportedInterfaces();
	...
	HV4DT_TYPE_ITERATOR::HV4DT_TYPE_ITERATOR(HV4D::IHV4DOBJECT const& sender, winrt::guid const& boxed, WF::IInspectable const& args)
	{
		HV4DListSupportedInterfaces();
	...
	HV4D::IHV4DOBJECT HV4DT_TYPE_ITERATOR::HV4DSender()
	{
		HV4DSetUpdatedDateTime();
	...
	void HV4DT_TYPE_ITERATOR::HV4DSender(HV4D::IHV4DOBJECT const& e)
	{
		HV4DSetUpdatedDateTime();
	...
	winrt::guid HV4DT_TYPE_ITERATOR::HV4DTType()
	{
		HV4DSetUpdatedDateTime();
