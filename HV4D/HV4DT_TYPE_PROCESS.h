...
#include "HV4DT_TYPE_PROCESS.g.h"

namespace WF = winrt::Windows::Foundation;

namespace winrt::HV4D::implementation
{
	struct HV4DT_TYPE_PROCESS : HV4DT_TYPE_PROCESST<HV4DT_TYPE_PROCESS>
	{
	public:
		HV4DT_TYPE_PROCESS();

	public:
		winrt::guid HV4DTType() { return winrt::guid{ L"{9991FB2C-6B05-4DB4-A45B-6554B5A00D3B}" }; }

	public:
		uint64_t HV4DTTypeID() { return 0x9991FB2C6B054DB4; };

	public:
		winrt::hstring HV4DTTypeName() { return L"HV4DT_TYPE_PROCESS"; }
...
{
	struct HV4DT_TYPE_PROCESS : HV4DT_TYPE_PROCESST<HV4DT_TYPE_PROCESS, implementation::HV4DT_TYPE_PROCESS>
	{
