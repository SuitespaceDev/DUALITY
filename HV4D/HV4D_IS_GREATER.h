...
{
	struct HV4D_IS_GREATER : HV4D_IS_GREATERT<HV4D_IS_GREATER>
	{
	public:
		HV4D_IS_GREATER();

		HV4D_IS_GREATER(HV4D::IHV4DCOBJECT const&);

		HV4D_IS_GREATER(HV4D::IHV4DCOBJECT const&, winrt::guid const&, WF::IInspectable const&);
...
{
	struct HV4D_IS_GREATER : HV4D_IS_GREATERT<HV4D_IS_GREATER, implementation::HV4D_IS_GREATER>
	{
