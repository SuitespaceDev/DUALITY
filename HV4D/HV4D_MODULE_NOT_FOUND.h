...
#include "HV4D_MODULE_NOT_FOUND.g.h"

namespace WF = winrt::Windows::Foundation;

namespace winrt::HV4D::implementation
{
	struct HV4D_MODULE_NOT_FOUND : HV4D_MODULE_NOT_FOUNDT<HV4D_MODULE_NOT_FOUND>
	{
	public:
		HV4D_MODULE_NOT_FOUND();

	public:
		winrt::guid ReturnType() { return winrt::guid{ L"{C8F4BA52-B4F2-4F73-AEB6-A2A68EE64631}" }; }

	public:
		uint64_t ID() { return 0xC8F4BA52B4F24F73; };

	public:
		winrt::hstring Name() { return L"HV4D_MODULE_NOT_FOUND"; }
...
{
	struct HV4D_MODULE_NOT_FOUND : HV4D_MODULE_NOT_FOUNDT<HV4D_MODULE_NOT_FOUND, implementation::HV4D_MODULE_NOT_FOUND>
	{
