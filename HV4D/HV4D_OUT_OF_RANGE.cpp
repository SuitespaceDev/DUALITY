...
namespace winrt::HV4D::implementation
{
	...
	HV4D_OUT_OF_RANGE::HV4D_OUT_OF_RANGE(HV4D::IHV4DCOBJECT const& sender)
	{
		HV4DListSupportedInterfaces();
	...
	HV4D_OUT_OF_RANGE::HV4D_OUT_OF_RANGE(HV4D::IHV4DCOBJECT const& sender, winrt::guid const& boxed, WF::IInspectable const& args)
	{
		HV4DListSupportedInterfaces();
	...
	HV4D::IHV4DCOBJECT HV4D_OUT_OF_RANGE::HV4DSender()
	{
		HV4DSetUpdatedDateTime();
	...
	void HV4D_OUT_OF_RANGE::HV4DSender(HV4D::IHV4DCOBJECT const& e)
	{
		HV4DSetUpdatedDateTime();
	...
	winrt::guid HV4D_OUT_OF_RANGE::HV4DReturnTypeUid()
	{
		HV4DSetUpdatedDateTime();
