...
#include "HV4DT_TYPE_SESSION.g.h"

namespace WF = winrt::Windows::Foundation;

namespace winrt::HV4D::implementation
{
	struct HV4DT_TYPE_SESSION : HV4DT_TYPE_SESSIONT<HV4DT_TYPE_SESSION>
	{
	public:
		HV4DT_TYPE_SESSION();

	public:
		winrt::guid HV4DTType() { return winrt::guid{ L"{2156F190-8DF7-44E0-A91D-A3E106C15A23}" }; }

	public:
		uint64_t HV4DTTypeID() { return 0x2156F1908DF744E0; };

	public:
		winrt::hstring HV4DTTypeName() { return L"HV4DT_TYPE_SESSION"; }
...
{
	struct HV4DT_TYPE_SESSION : HV4DT_TYPE_SESSIONT<HV4DT_TYPE_SESSION, implementation::HV4DT_TYPE_SESSION>
	{
