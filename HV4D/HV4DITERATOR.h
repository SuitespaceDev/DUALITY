...
{
	struct HV4DITERATOR : HV4DITERATORT<HV4DITERATOR>
	{
	public:
		HV4DITERATOR();

		HV4DITERATOR(HV4D::IHV4DOBJECT const&);

		HV4DITERATOR(HV4D::IHV4DOBJECT const&, winrt::guid const&, WF::IInspectable const&);
...
{
	struct HV4DITERATOR : HV4DITERATORT<HV4DITERATOR, implementation::HV4DITERATOR>
	{
