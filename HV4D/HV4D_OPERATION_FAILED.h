...
#include "HV4D_OPERATION_FAILED.g.h"

namespace WF = winrt::Windows::Foundation;

namespace winrt::HV4D::implementation
{
	struct HV4D_OPERATION_FAILED : HV4D_OPERATION_FAILEDT<HV4D_OPERATION_FAILED>
	{
	public:
		HV4D_OPERATION_FAILED();

	public:
		winrt::guid ReturnType() { return winrt::guid{ L"{6B2F41EC-BBF3-4D07-9EA9-45617B32B91D}" }; }

	public:
		uint64_t ID() { return 0x6B2F41ECBBF34D07; };

	public:
		winrt::hstring Name() { return L"HV4D_OPERATION_FAILED"; }
...
{
	struct HV4D_OPERATION_FAILED : HV4D_OPERATION_FAILEDT<HV4D_OPERATION_FAILED, implementation::HV4D_OPERATION_FAILED>
	{
