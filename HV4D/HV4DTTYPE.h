...
{
	struct HV4DTTYPE : HV4DTTYPET<HV4DTTYPE>
	{
	public:
		HV4DTTYPE();

		HV4DTTYPE(HV4D::IHV4DOBJECT const&);

		HV4DTTYPE(HV4D::IHV4DOBJECT const&, winrt::guid const&, WF::IInspectable const&);
...
{
	struct HV4DTTYPE : HV4DTTYPET<HV4DTTYPE, implementation::HV4DTTYPE>
	{
