...
{
	struct HV4DT_TYPE_UNKNOWN : HV4DT_TYPE_UNKNOWNT<HV4DT_TYPE_UNKNOWN>
	{
	public:
		HV4DT_TYPE_UNKNOWN();

		HV4DT_TYPE_UNKNOWN(HV4D::IHV4DCOBJECT const&);

		HV4DT_TYPE_UNKNOWN(HV4D::IHV4DCOBJECT const&, winrt::guid const&, WF::IInspectable const&);
...
{
	struct HV4DT_TYPE_UNKNOWN : HV4DT_TYPE_UNKNOWNT<HV4DT_TYPE_UNKNOWN, implementation::HV4DT_TYPE_UNKNOWN>
	{
