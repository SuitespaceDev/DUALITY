...
#include "HV4DTHstringFromGUID.g.h"

namespace winrt::HV4DABI::implementation
{
	struct HV4DTHstringFromGUID : HV4DTHstringFromGUIDT<HV4DTHstringFromGUID>
	{
	public:
		HV4DTHstringFromGUID();
...
{
	struct HV4DTHstringFromGUID : HV4DTHstringFromGUIDT<HV4DTHstringFromGUID, implementation::HV4DTHstringFromGUID>
	{
