...
namespace winrt::HV4DABI
{
	...
	bool CHV4DMMM::operator == (hstring const& s) const
	{
		CHV4DMMM mmm{ s };
	...
	HV4DRETURN CHV4DMMM::HV4DGetHstringMMM(hstring& o) const
	{
		o = o + tagMMM[0];
		o = o + '.';
		o = o + tagMMM[1];
	...
	HV4DRETURN CHV4DMMM::HV4DGetNumericMMM(long& mil, long& maj, long& min) const
	{
		hstring str_mil = hstring{ tagMMM[0] };

		hstring str_maj = hstring{ tagMMM[1] } + tagMMM[2] + tagMMM[3];

		hstring str_min = hstring{ tagMMM[4] } + tagMMM[5] + tagMMM[6];
	...
	HV4DRETURN CHV4DMMM::HV4DGetArrayMMM(wchar_t a[7]) const
	{
	...
	HV4DRETURN CHV4DMMM::HV4DGetWinrtMMM(MMM& e) const
	{
		e.mil = hstring{ tagMMM[0] };

		e.maj = hstring{ tagMMM[1] } + tagMMM[2] + tagMMM[3];

		e.min = hstring{ tagMMM[4] } + tagMMM[5] + tagMMM[6];
