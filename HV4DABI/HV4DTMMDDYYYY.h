...
#include "HV4DTMMDDYYYY.g.h"

namespace winrt::HV4DABI::implementation
{
	struct HV4DTMMDDYYYY : HV4DTMMDDYYYYT<HV4DTMMDDYYYY>
	{
	public:
		HV4DTMMDDYYYY();
...
{
	struct HV4DTMMDDYYYY : HV4DTMMDDYYYYT<HV4DTMMDDYYYY, implementation::HV4DTMMDDYYYY>
	{
