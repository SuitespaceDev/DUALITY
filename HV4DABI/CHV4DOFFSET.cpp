...
namespace winrt::HV4DABI
{
	...
	HV4DRETURN CHV4DOFFSET::HV4DGetHstringOFFSET(hstring& o, hstring& sz) const
	{
		long long ret_off{};
	...
	HV4DRETURN CHV4DOFFSET::HV4DGetNumericOFFSET(long long& o, long long& sz) const
	{
	...
	HV4DRETURN CHV4DOFFSET::HV4DGetDWORDOFFSET(DWORD& o_bot, DWORD& o_upp, DWORD& sz_bot, DWORD& sz_upp) const
	{
	...
	HV4DRETURN CHV4DOFFSET::HV4DGetArrayOFFSET(wchar_t a[4], wchar_t b[4]) const
	{
	...
	HV4DRETURN CHV4DOFFSET::HV4DGetWinrtOFFSET(OFFSET& e) const
	{
		byte array[8]{};
