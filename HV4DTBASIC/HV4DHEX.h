...
{
	struct HV4DHEX : HV4DHEXT<HV4DHEX>
	{
	public:
		HV4DHEX();

		HV4DHEX(HV4D::IHV4DCOBJECT const&);

		HV4DHEX(HV4D::IHV4DCOBJECT const&, winrt::guid const&, WF::IInspectable const&);
...
{
	struct HV4DHEX : HV4DHEXT<HV4DHEX, implementation::HV4DHEX>
	{
