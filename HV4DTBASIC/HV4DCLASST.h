...
namespace winrt::HV4DTBASIC::implementation
{
	...
	public:
		...
		HV4D::IHV4DRETURN HV4DFromABI(winrt::HV4DTBASIC::CLASST const&);

		HV4D::IHV4DRETURN HV4DFromWinRT(winrt::HV4DTBASIC::HV4DCLASST const&);

		HV4D::IHV4DRETURN HV4DToHstring(winrt::hstring&, winrt::hstring&);

		HV4D::IHV4DRETURN HV4DToABI(winrt::HV4DTBASIC::CLASST&);

		HV4D::IHV4DRETURN HV4DToWinRT(winrt::HV4DTBASIC::HV4DCLASST&);

		HV4D::IHV4DRETURN HV4DIsEqualHstring(winrt::hstring const&, winrt::hstring const&);

		HV4D::IHV4DRETURN HV4DIsEqualABI(winrt::HV4DTBASIC::CLASST const&);

		HV4D::IHV4DRETURN HV4DIsEqualWinRT(winrt::HV4DTBASIC::HV4DCLASST const&);
