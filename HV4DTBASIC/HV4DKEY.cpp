...
namespace winrt::HV4DTBASIC::implementation
{
	...
	HV4DKEY::HV4DKEY(HV4D::IHV4DOBJECT const& sender)
	{
		HV4DListSupportedInterfaces();
	...
	HV4DKEY::HV4DKEY(HV4D::IHV4DOBJECT const& sender, winrt::guid const& boxed, WF::IInspectable const& args)
	{
		HV4DListSupportedInterfaces();
	...
	uint64_t HV4DKEY::HV4DCreatedDateTime()
	{
	...
	uint64_t HV4DKEY::HV4DUpdatedDateTime()
	{
	...
	HV4D::IHV4DOBJECT HV4DKEY::HV4DSender()
	{
		HV4DSetUpdatedDateTime();
	...
	void HV4DKEY::HV4DSender(HV4D::IHV4DOBJECT const& e)
	{
		HV4DSetUpdatedDateTime();
