...
namespace winrt::HV4DTBASIC::implementation
{
	...
	HV4DHVID::HV4DHVID(HV4D::IHV4DCOBJECT const& sender)
	{
		HV4DListSupportedInterfaces();
	...
	HV4DHVID::HV4DHVID(HV4D::IHV4DCOBJECT const& sender, winrt::guid const& boxed, WF::IInspectable const& args)
	{
		HV4DListSupportedInterfaces();
	...
	HV4D::IHV4DCOBJECT HV4DHVID::HV4DSender()
	{
		HV4DSetUpdatedDateTime();
	...
	void HV4DHVID::HV4DSender(HV4D::IHV4DCOBJECT const& e)
	{
		HV4DSetUpdatedDateTime();
