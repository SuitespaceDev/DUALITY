...
namespace winrt::HV4DTBASIC::implementation
{
	...
	HV4DMMDDYYYY::HV4DMMDDYYYY(HV4D::IHV4DCOBJECT const& sender)
	{
		HV4DListSupportedInterfaces();
	...
	HV4DMMDDYYYY::HV4DMMDDYYYY(HV4D::IHV4DCOBJECT const& sender, winrt::guid const& boxed, WF::IInspectable const& args)
	{
		HV4DListSupportedInterfaces();
	...
	HV4D::IHV4DCOBJECT HV4DMMDDYYYY::HV4DSender()
	{
		HV4DSetUpdatedDateTime();
	...
	void HV4DMMDDYYYY::HV4DSender(HV4D::IHV4DCOBJECT const& e)
	{
		HV4DSetUpdatedDateTime();
