...
namespace winrt::HV4DTBASIC::implementation
{
	...
	public:
		...
		HV4DNUMERIC(HV4D::IHV4DCOBJECT const&);

		HV4DNUMERIC(HV4D::IHV4DCOBJECT const&, winrt::guid const&, WF::IInspectable const&);
	...
	public:
		virtual HV4D::IHV4DRETURN HV4DNUMERICFromNUM(std::uint64_t const&);
