...
namespace HV4D::CHV4DTBASIC
{
	...
	void CHV4DRTCLASS::HV4DGetWinrtRTClass(RTCLASS& o)
	{
		try
		{
			HV4DIsValidRTCLASS();
	...
	void CHV4DRTCLASS::HV4DReadNodeRTClass(xml_node const& e)
	{
		...
		std::wstring_view ValueClassType{ L"" };
	...
	void CHV4DRTCLASS::HV4DWriteNodeRTClass(xml_node const& e)
	{
		xml_node HV4DRTCLASS{ e };
	...
	void CHV4DRTCLASS::HV4DReadHVID(xml_node const& e)
	{
		std::wstring_view hvid{};
	...
	void CHV4DRTCLASS::HV4DWriteHVID(xml_node const& e)
	{
		std::wstring_view hvid{};
	...
	void CHV4DRTCLASS::HV4DReadMMM(xml_node const& e)
	{
		std::wstring_view mmm{};
	...
	void CHV4DRTCLASS::HV4DWriteMMM(xml_node const& e)
	{
		std::wstring_view mmm{};
	...
	void CHV4DRTCLASS::HV4DReadNAME(xml_node const& e)
	{
	...
	void CHV4DRTCLASS::HV4DWriteNAME(xml_node const& e)
	{
		std::wstring_view name{};
	...
	void CHV4DRTCLASS::HV4DReadDLLPath(xml_node const& e)
	{
		std::wstring_view path{}, dll{};
	...
	void CHV4DRTCLASS::HV4DWriteDLLPath(xml_node const& e)
	{
		std::wstring_view path{}, dll{};
	...
	void CHV4DRTCLASS::HV4DReadDLL(xml_node const& e)
	{
		std::wstring_view path{}, dll{};
	...
	void CHV4DRTCLASS::HV4DWriteDLL(xml_node const& e)
	{
		std::wstring_view path{}, dll{};
	...
	void CHV4DRTCLASS::HV4DWriteRTCNS(xml_node const& e)
	{
		std::wstring_view ns{}, rtc{};
	...
	void CHV4DRTCLASS::HV4DReadRTCNS(xml_node const& e)
	{
		std::wstring_view ns{}, rtc{};
	...
	void CHV4DRTCLASS::HV4DReadRTC(xml_node const& e)
	{
		std::wstring_view ns{}, rtc{};
	...
	void CHV4DRTCLASS::HV4DWriteRTC(xml_node const& e)
	{
		std::wstring_view ns{}, rtc{};
